...
Donate link: https://mindfuldesign.me
Tags: media, video, audio, playlist, archive, youtube, vimeo, soundcloud, archive.org
...
MindfulMedia is a powerful WordPress media management plugin that helps you organize and display audio, video, and multimedia content with a beautiful, YouTube-inspired interface.

**Key Features:**

* **Custom Post Type** - Dedicated `mindful_media` post type for managing media items
* **Multiple Taxonomies** - Organize by Categories, Types (Audio/Video), Topics, Teachers, and Playlists (Series)
* **YouTube-Style Card Grid** - Beautiful responsive card layouts with 16:9 thumbnails
...
* **Multiple Player Support** - YouTube, Vimeo, SoundCloud, and Archive.org
...
1. Archive page with YouTube-style filter chips
2. Browse page with Netflix-style horizontal sliders
3. Modal player with dark theme and playlist sidebar
4. Single media page with related content
5. Admin settings page
6. Getting Started page
...
= 2.7.0 =
This version includes a redesigned Getting Started page with improved branding and cleaner interface.

= 2.6.5 =
Security update: Adds nonce verification to AJAX handlers. Recommended for all users.

= 2.6.0 =
New feature: Search functionality added to all archive and browse pages.
