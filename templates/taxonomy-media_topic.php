        ...
        ?>
            <section class="mindful-media-topic-section" data-teacher="<?php echo esc_attr($teacher->slug); ?>">
                ...
                <div class="mindful-media-topic-grid">
                    ...
                    ?>
                        <article class="mindful-media-topic-card mindful-media-card" data-post-id="<?php echo esc_attr($post_id); ?>" data-search="<?php echo esc_attr(MindfulMedia_Shortcodes::build_search_text($post_id)); ?>" data-teacher="<?php echo esc_attr($teacher->slug); ?>" data-type="<?php echo esc_attr($type_slug); ?>" data-duration="<?php echo esc_attr($duration_slug); ?>" data-year="<?php echo esc_attr($year_slug); ?>">
        ...
        ?>
            <section class="mindful-media-topic-section" data-teacher="uncategorized">
                ...
                <div class="mindful-media-topic-grid">
                    ...
                    ?>
                        <article class="mindful-media-topic-card mindful-media-card" data-post-id="<?php echo esc_attr($post_id); ?>" data-search="<?php echo esc_attr(MindfulMedia_Shortcodes::build_search_text($post_id)); ?>" data-teacher="uncategorized" data-type="<?php echo esc_attr($type_slug); ?>" data-duration="<?php echo esc_attr($duration_slug); ?>" data-year="<?php echo esc_attr($year_slug); ?>">
                            <div class="mindful-media-topic-card-thumb">
                                <button type="button" class="mindful-media-thumb-trigger" data-post-id="<?php echo esc_attr($post_id); ?>" data-title="<?php echo esc_attr($post->post_title); ?>" style="background: none; border: none; padding: 0; width: 100%; height: 100%; cursor: pointer;">
                                    <img src="<?php echo esc_url($thumbnail_url); ?>" alt="<?php echo esc_attr($post->post_title); ?>" loading="lazy">
